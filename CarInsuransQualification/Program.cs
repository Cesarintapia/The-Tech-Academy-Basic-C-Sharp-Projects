...
namespace CarInsuransQualification
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int ageLegal = 15;                       // Set condition type integer
            bool agenPermited = agePerson >= ageLegal; // Compare ageLegal with agePerson and the result is agePermited tyoe boolean
            Console.WriteLine(agenPermited);            // Print Permited age

            Console.WriteLine("Have you ever had a DUI? answer:\"true\" or \"false\""); //Ask for DUI
            bool dui = Convert.ToBoolean(Console.ReadLine());         //Convert the answer in boolean
